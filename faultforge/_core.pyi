...
def embedded_parity_encode_f32(arr: npt.NDArray[np.float32]) -> None: ...
def embedded_parity_decode_f32(arr: npt.NDArray[np.float32]) -> None: ...
def embedded_parity_encode_u16(arr: npt.NDArray[np.uint16]) -> None: ...
def embedded_parity_decode_u16(arr: npt.NDArray[np.uint16]) -> None: ...
