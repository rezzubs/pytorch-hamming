...
def encode_f32(tensor: torch.Tensor) -> torch.Tensor:
    """Enocde a flattened float32 tensor as 34 byte hamming codes.

    See module docs for details.
    """
    f = hamming_core.u256.encode_f32  # type: ignore
...
def decode_f32(tensor: torch.Tensor) -> tuple[torch.Tensor, int]:
    ...
    See module docs for details.
    """
    f = hamming_core.u256.decode_f32  # type: ignore
...
def encoded_tensor_list_fi(
    ...
    See module docs for details.
    """
    f = hamming_core.u256.array_list_fi  # type: ignore
    tensor_list_fi_impl(
        tensors,
        bit_error_rate,
        torch.uint8,
